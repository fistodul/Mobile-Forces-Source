...
CLIENTEFFECT_REGISTER_BEGIN(PrecacheEffectSniper)
...
class C_Sniper : public C_BaseCombatCharacter
{
	DECLARE_CLASS(C_Sniper, C_BaseCombatCharacter);
	DECLARE_CLIENTCLASS();
public:
...
private:
	...
	C_Sniper(const C_Sniper &); // not defined, not accessible

	Vector	m_vecLastOrigin;
	bool	m_bUpdated;
};

IMPLEMENT_CLIENTCLASS_DT(C_Sniper, DT_Sniper, CSniper)
END_RECV_TABLE()

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
C_Sniper::C_Sniper(void)
{
}
...
// Input  : updateType - 
//-----------------------------------------------------------------------------
void C_Sniper::OnDataChanged(DataUpdateType_t updateType)
{
...
// Output : int
//-----------------------------------------------------------------------------
int C_Sniper::DrawModel(int flags)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_Sniper::ClientThink(void)
{
	m_bUpdated = false;
}

//-----------------------------------------------------------------------------
// Purpose: the same shit as in c_weapon_crossbow apparently
// Input  : &data - 
//-----------------------------------------------------------------------------
