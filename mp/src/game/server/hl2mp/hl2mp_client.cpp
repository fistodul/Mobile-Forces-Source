...
//============================================================================================
			...
			if (PlayerClassValue == 1)
			{
				...
				pPlayer->SetModel( "models/Humans/Group03/male_06_sdk.mdl" );
			...
			pPlayer->m_iCurrentClass = 2;
				...
				pPlayer->SetModel( "models/Humans/Group03/l7h_rebel.mdl" );
			...
			pPlayer->m_iCurrentClass = 3;
				...
				pPlayer->SetModel( "models/Humans/Group03/male_05.mdl" );
			...
			pPlayer->m_iCurrentClass = 4;
				...
				pPlayer->SetModel( "models/police_05.mdl" );
