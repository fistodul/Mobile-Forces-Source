...
static int gEntList_FindEntityByClassnameNearest (lua_State *L) {
  lua_pushentity(L, gEntList.FindEntityByClassnameNearest(luaL_checkstring(L, 1), luaL_checkvector(L, 2), luaL_checknumber(L, 3)/*, luaL_optint(L, 4, 0)*/));
  return 1;
}

static int gEntList_FindEntityByClassnameWithin (lua_State *L) {
  lua_pushentity(L, gEntList.FindEntityByClassnameWithin(lua_toentity(L, 1), luaL_checkstring(L, 2), luaL_checkvector(L, 3),/* luaL_checknumber(L, 4),*/ luaL_optint(L, 5, 0)));
  return 1;
}
...
static int gEntList_FindEntityByNameNearest (lua_State *L) {
  lua_pushentity(L, gEntList.FindEntityByNameNearest(luaL_checkstring(L, 1), luaL_checkvector(L, 2), luaL_checknumber(L, 3), luaL_optentity(L, 4, 0), luaL_optentity(L, 5, 0), luaL_optentity(L, 6, 0)/*, luaL_optint(L, 7, 0)*/));
  return 1;
}

static int gEntList_FindEntityByNameWithin (lua_State *L) {
  lua_pushentity(L, gEntList.FindEntityByNameWithin(lua_toentity(L, 1), luaL_checkstring(L, 2), luaL_checkvector(L, 3), luaL_checknumber(L, 4), luaL_optentity(L, 5, 0), luaL_optentity(L, 6, 0), luaL_optentity(L, 7, 0)/*, luaL_optint(L, 7, 0)*/));
  return 1;
}
...
static int gEntList_FindEntityGenericNearest (lua_State *L) {
  lua_pushentity(L, gEntList.FindEntityGenericNearest(luaL_checkstring(L, 1), luaL_checkvector(L, 2), luaL_checknumber(L, 3), luaL_optentity(L, 4, 0), luaL_optentity(L, 5, 0), luaL_optentity(L, 6, 0)/*, luaL_optint(L, 7, 0)*/));
  return 1;
}

static int gEntList_FindEntityGenericWithin (lua_State *L) {
  lua_pushentity(L, gEntList.FindEntityGenericWithin(lua_toentity(L, 1), luaL_checkstring(L, 2), luaL_checkvector(L, 3), luaL_checknumber(L, 4), luaL_optentity(L, 5, 0), luaL_optentity(L, 6, 0), luaL_optentity(L, 7, 0)/*, luaL_optint(L, 8, 0)*/));
  return 1;
}
