    ...
    ISpObjectToken **ppObjectToken)
{
	...
	const size_t ulLenVendorPreferred = wcslen(pszVendorPreferred); // fixed no size_t
...
public:
	...
	static long CoMemCopyWFEX(const WAVEFORMATEX * pSrc, WAVEFORMATEX ** ppCoMemWFEX) // fixed missing long
    {
                             ...
                             CComPtr<ISpPhoneConverter> cpPhoneConv = NULL)
{
    ...
    SPPHONEID* pphoneId = (SPPHONEID*)((WCHAR *)dsPhoneId); // fixed improper casting
