                             ...
                             CComPtr<ISpPhoneConverter> cpPhoneConv = NULL)
{
    ...
    SPPHONEID* pphoneId = (SPPHONEID*)((WCHAR *)dsPhoneId); // improper casting //SPPHONEID* pphoneId = dsPhoneId;
        ...
        if (*p == L'/')
        {
            ...
            if ( pszThirdPart)
            {
                ...
                if (SUCCEEDED(hr))
                {
                    ...
                    pphoneId += wcslen((const wchar_t *)pphoneId) + 1; // improper casting //pphoneId += wcslen(pphoneId) + 1;
                }
            }
        }
        else
